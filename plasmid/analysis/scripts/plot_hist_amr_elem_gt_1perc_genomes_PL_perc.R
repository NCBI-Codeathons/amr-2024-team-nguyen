...
ggsave("figures/element_stats.denovo.1per_genomes.10-90per_pl.png", plot = plot, width = 8, height = 6, dpi = 300)

# Load the TSV file into a data frame
# Replace 'your_file.tsv' with your actual file path
data <- read.csv('element_stats.denovo.1per_genomes.20-80per_pl.tsv', sep = '\t', header = TRUE)
...
ggsave("figures/element_stats.denovo.1per_genomes.20-80per_pl.png", plot = plot, width = 8, height = 6, dpi = 300)
